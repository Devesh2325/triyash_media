...
export const POSTS: Post[] = [
  {
    ...
    body: [
      { type: "p", text: "We audit roughly one hotel brand film a week. Most of them share the same problem — and it isn't budget." },
      { type: "p", text: "The typical brief goes something like: \"we want something cinematic, aspirational, and emotional.\" The output is technically beautiful. Slow dolly of a lit facade. A wine glass, backlit. A couple laughing on a terrace at 4 p.m. Everything the director learned in film school, executed with taste." },
      { type: "p", text: "And it converts nobody." },
      { type: "h2", text: "The mistake: filming for the awards panel, not the traveller" },
      { type: "p", text: "The tell is always the same. Every frame is a hotel showing off to other hotels. It's beautiful, it's tasteful — and it's aimed at an audience that will never book a room." },
      { type: "p", text: "Real travellers make decisions the way real people make decisions: fast, emotionally, on a phone, in a moment of tension between what they want and what they can afford. The brand film has to close that gap in six seconds. Most hotel films spend the first fifteen seconds proving that the director owns a good camera." },
      { type: "quote", text: "A brand film that wins awards but doesn't book rooms is a portfolio piece for the director. Not an asset for the hotel.", cite: "Priyansh Bhatia, Founder" },
      ...
      { type: "p", text: "Answer those three questions and you've written 80% of the treatment. Everything else — the drone shot, the food montage, the couple on the terrace — is service to that one frame." },
      { type: "p", text: "The best hotel films we've made in the last five years all pass this test. So do the ones that consistently drive direct bookings. It's not a coincidence." },
      { type: "h2", text: "What we do differently" },
      { type: "p", text: "Every brand film we shoot starts with a one-page treatment that answers those three questions in plain English. If we can't answer them, we don't shoot — no matter how big the budget. That discipline is the entire difference between a beautiful film and a booked hotel." },
    ],
  },
  {
    ...
    body: [
      { type: "p", text: "In 2018, drone footage for a resort meant an orbit shot of the pool, a top-down of the beach, and a slow reveal of the sunset. Beautiful in isolation. Interchangeable in aggregate." },
      { type: "p", text: "In 2026, the drone is a director's camera. FPV rigs weave through infinity pools, chase a jeep down a mountain road, then break through a curtain into a candle-lit dinner. The audience doesn't feel like they're watching drone footage. They feel like they're moving through the property." },
      { type: "h2", text: "The technical shift, in one paragraph" },
      { type: "p", text: "Cinema drones now carry the same sensors as our A-cameras. FPV rigs are stable enough for indoor work. Software-defined obstacle avoidance means we can fly closer to guests and structure without spooking either. The result: sequences that were unthinkable, or wildly expensive, five years ago are now a normal shoot day." },
      { type: "h2", text: "The creative shift is the real story" },
      { type: "p", text: "Because the technology is trivial, the differentiator has moved back to direction. The best resort films of the last two years aren't the ones with the fanciest drones — they're the ones that treat the drone like an invisible character with a point of view." },
      { type: "list", items: [
  ...
  },
  {
    ...
    body: [
      { type: "p", text: "For most of the last decade, food photography was ruled by one aesthetic: dark, moody, over-saturated, shot from above, with the chef's hand entering the frame from the right." },
      { type: "p", text: "It's finally dead. What's replacing it is more interesting than what it replaced." },
  ...
  },
  {
    ...
    body: [
      { type: "p", text: "Colour is the last conversation your viewer has with the film before they decide how they feel about it. Everything else is negotiable. Colour isn't." },
      { type: "h2", text: "The three-pass grade" },
      { type: "p", text: "We grade in three passes. The first is correction: matching cameras, fixing exposure, honouring skin tones. The second is creative: the film's palette, its temperature, its emotional register. The third is finishing: subtle vignettes, halation, film grain, and the tiny touches that separate a graded film from a colour-corrected one." },
      { type: "quote", text: "A good grade is invisible. A great grade is the reason you can't look away.", cite: "Studio grading room" },
      { type: "h2", text: "The tools matter less than you'd think" },
      { type: "p", text: "We work in DaVinci Resolve on calibrated reference monitors, but the tool is 10% of the outcome. The other 90% is the colourist's eye and the director's willingness to protect the palette when the client's team asks for it to be brighter, warmer, or more like a competitor." },
  ...
  },
  {
    ...
    body: [
      { type: "p", text: "For independent hotels, the local pack is the entire game. Rank in the top three for \"boutique hotel Pune\" and your calendar fills itself. Miss it and you're funding Booking.com forever." },
      ...
      { type: "p", text: "That's roughly 80% of what moves the needle. The other 20% is technical: fast site, structured data, clean URLs, mobile-first design, no janky third-party booking widgets." },
      ...
      { type: "p", text: "The rules of the game have moved from \"be visible\" to \"be quotable.\" The good news: quotable content also converts better with humans." },
    ],
  },
  {
    ...
    body: [
      { type: "p", text: "Every serious founder has an audience of at least a thousand people who care what they think — customers, investors, employees, journalists, peers. The founder documentary is the most under-priced way to speak to all of them at once." },
      { type: "h2", text: "Why now" },
      { type: "p", text: "Podcasts trained the audience. YouTube made the format viable. Cinema-quality cameras got cheap enough that a two-day shoot produces a film that would have cost a hundred thousand dollars a decade ago. The window is open." },
      ...
      { type: "p", text: "The good ones share a trait: they treat the founder as a character, not a spokesperson. Character has flaws, moments of doubt, and a real stake. Spokespeople have talking points. Audiences remember characters." },
    ],
  },
  {
    ...
    body: [
      { type: "p", text: "Most wedding films are watched twice: on the honeymoon, and again on the first anniversary. Then they live on a hard drive nobody knows how to find." },
      { type: "p", text: "The great ones are watched every anniversary for thirty years. The difference isn't camera work. It's editorial." },
      { type: "h2", text: "The archive test" },
      { type: "p", text: "Before we shoot, we ask the couple one question: what will you want to see on your fifteenth anniversary that no other camera will capture? The answers are almost never the ceremony or the first dance. They're the tiny, unrehearsed moments — a father adjusting his tie, a grandmother asleep at 3 a.m., a friend crying at the bar." },
      { type: "p", text: "That answer becomes the treatment. The ceremony gets covered because it has to be. The archive is where we actually shoot." },
    ],
  },
  {
    ...
    body: [
      { type: "p", text: "We've walked into 200-crore properties whose listings looked like a WhatsApp forward, and 3-crore properties whose listings looked like Architectural Digest. The gap is almost never the property." },
      ...
      { type: "p", text: "Five shots. Done well, they'll do more work than sixty done badly. Every additional shot after those five should either add information or add mood — nothing else." },
    ],
  },
];
