  ...
  return (
    <>
      ...
      <section className="container-luxe pb-24 max-w-3xl prose prose-invert">
        ...
        <Block t="Your rights">Email <a className="text-gold" href="mailto:hello@triyashmedia.com">hello@triyashmedia.com</a> any time to access, correct or delete your data.</Block>
